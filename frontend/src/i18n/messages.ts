...
export const messages: Record<Locale, Record<string, unknown>> = {
  en: {
    ...
    dashboard: {
      ...
      dropImage: "Drag & drop up to 5 clear ID screenshots (PNG / JPG / WEBP), or browse",
      ...
      errNeedImage: "Please choose 1 to 5 screenshots (PNG, JPG, or WEBP).",
  ...
  am: {
    ...
    dashboard: {
      ...
      dropImage: "ከ1 እስከ 5 የID ቅጽበታዊ (PNG / JPG / WEBP) ይጎትቱ ወይም ይምረጡ",
      chooseFile: "ፋይል(ሎች) ምረጥ",
      ...
      errNeedImage: "እባክዎ 1 እስከ 5 ቅጽበታዊ (PNG/JPG/WEBP) ይምረጡ።",
